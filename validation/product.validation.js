...
const productSchema = Joi.object({
  ...
  price: Joi.number().positive().precision(2).required().messages({
    ...
    'number.precision': 'Giá sản phẩm tối đa 2 chữ số thập phân.',
    'any.required': 'Giá sản phẩm là bắt buộc.'
  }),
  category_id: Joi.number().integer().allow(null).messages({
    'number.base': 'ID danh mục phải là số nguyên.',
  ...
  image_url: Joi.string().allow(null, '').messages({
