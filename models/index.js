...
sequelize.authenticate().then(() => { console.log('Kết nối database với Sequelize thành công!'); }).catch(err => { console.error('Không thể kết nối database:', err); process.exit(1); });
const db = {};
